	...
	<div id="search_bar" class="mt10">
       <div class="box">
          <div class="box_border">
            ...
            <form action="/StuManagement/An.action?dm=addAnno" align="center" method="post">
            <span>标题：</span><input type="text" name="atitle"  class="one" >
            <br>
     		 <span class="arti">内容：</span>
     		 <br>
     		 <textarea rows="" cols="" class="two" name="amessage" ></textarea>
       		<br>
