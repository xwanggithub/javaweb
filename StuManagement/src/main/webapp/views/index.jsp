...
<body>
    ...
    <div class="side">
        <div class="sideMenu" style="margin:0 auto">
          <h3>我的</h3>
          <ul >
            <li><a href="/StuManagement/Stu.action?dm=queryStuInfo" target="right">学籍信息</a></li>
            <li><a href="/StuManagement/Stu.action?dm=getStuGrades" target="right">我的成绩</a></li>	
            <li><a href="/StuManagement/Stu.action?dm=myCourse"     target="right">我的选课</a></li>
          </ul>
          <h3>教评</h3>
          <ul >
            <li><a href="/StuManagement/Stu.action?dm=showMyCose" target="right">统一教评</a></li>
    ...
    <div class="main">
       <iframe name="right" id="rightMain" src="/StuManagement/An.action?dm=querryAnno" frameborder="no" scrolling="auto" width="100%" height="auto" allowtransparency="true"></iframe>
    </div>
